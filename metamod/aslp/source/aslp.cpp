...
#define REGISTER_AS_HOOK_ALT(base_name, des, tag, name, arg) CREATE_AS_HOOK(base_name, des, tag, name, arg)
void RegisterAngelScriptHooks()
{
	...
	//REGISTER_AS_HOOK(pTraceLine, "Pre call of gEntityInterface.pfnTraceLine", "ASLP::Engine", "Vector vecSrc, Vector vecEnd, int fNoMonsters, edict_t@ ent, TraceResult& out ptr, META_RES& out meta_result");

	/*Player*/
	REGISTER_AS_HOOK(pPlayerPreTakeHealth, "Pre call before a player will recive health", "ASLP::Player", "HealthInfo@ pInfo");
	...
	REGISTER_AS_HOOK(pMonsterPreTraceAttack, "Pre call before a monster will be get traced attack", "ASLP::Monster", "TraceInfo@ pInfo");
	REGISTER_AS_HOOK(pMonsterPostTraceAttack, "Post call after a monster will be get traced attack", "ASLP::Monster", "TraceInfo@ pInfo");
	REGISTER_AS_HOOK(pMonsterPreKilled, "Pre call before a monster will be killed", "ASLP::Monster", "CBaseMonster@ pMonster, entvars_t@ pevAttacker, int& out iGib");
	REGISTER_AS_HOOK(pMonsterPostKilled, "Post call after a monster is killed", "ASLP::Monster", "CBaseMonster@ pMonster, entvars_t@ pevAttacker, int iGib");
	REGISTER_AS_HOOK(pMonsterPreUse, "Pre call before a monster will be used", "ASLP::Monster",  "CBaseMonster@ pMonster, CBaseEntity@ pActivator, CBaseEntity@ pCaller, int& out useType, float& out value" );
	REGISTER_AS_HOOK(pMonsterPostUse, "Post call after a monster is used", "ASLP::Monster", "CBaseMonster@ pMonster, CBaseEntity@ pActivator, CBaseEntity@ pCaller, int useType, float value" );
	REGISTER_AS_HOOK(pMonsterPreRevive, "Pre call before a monster will be revived", "ASLP::Monster", "CBaseMonster@ pMonster");
	REGISTER_AS_HOOK(pMonsterPostRevive, "Post call after a monster will be revived", "ASLP::Monster", "CBaseMonster@ pMonster");
